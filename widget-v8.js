(function() {
    ...
    // 1. Inject the CSS (Strictly scoped to prevent CSS bleeding to the main page)
    const styles = `
        ...
        #my-mock-widget .calendar-scroll-area { max-height: 40vh; overflow-y: auto; padding-right: 5px; margin-bottom: 15px; }
        ...
        /* Updated Hover and Selected states to Eggplant (#3C0C3D) */
        ...
        #my-mock-widget .calendar-day.selected .price { color: #f5eef5; }
        ...
        /* Changed from Green to Eggplant */
        #my-mock-widget .price { font-size: 0.75em; color: #3C0C3D; margin-top: 4px; font-weight: 600; }
        ...
        /* Changed CTA Button to Eggplant */

(function() {
    ...
    if (!targetDiv) return; // Stop if the target isn't found
    ...
    // 4. Inject the calendar HTML into the target div
    targetDiv.innerHTML = `
    ...
    const calendarDays = targetDiv.querySelectorAll('.calendar-day');
